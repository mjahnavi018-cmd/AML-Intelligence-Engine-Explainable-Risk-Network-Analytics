...
| **Data** | Official IBM AMLSim sample (Apache-2.0): sender, receiver, amount, day step, AML-typology label. Synthetic and not Indian - see [DATA_SOURCES.md](DATA_SOURCES.md). No payment-fraud label exists, so no supervised fraud detection is claimed. |
